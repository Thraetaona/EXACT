...
(;    $0x10 $0x11 $0x12 $0x13 $0x14 $0x15 $0x16 $0x17 $0x18 $0x19 $0x1a $0x1b $0x1c $0x1d $0x1e $0x1f (; 1 ;)
    ...
    $UD   $UD   $UD   $UD   $0x84 $0x85 $0x86 $0x87 $0x88 $0x89 $0x8a $0x8b $0x8c $0x8d $0x8e $0x8f (; 8 ;)
    ...
    $UD   $UD   $UD   $UD   $0xd4 $0xd5 $0xd6 $0xd7 $UD   $UD   $UD   $UD   $UD   $UD   $UD   $UD   (; D ;)
    $0xe0 $0xe1 $0xe2 $0xe3 $0xe4 $0xe5 $0xe6 $0xe7 $0xe8 $0xe9 $0xea $0xeb $0xec $0xed $0xee $0xef (; E ;)
    $0xf0 $0xf1 $0xf2 $0xf3 $0xf4 $0xf5 $UD   $UD   $0xf8 $0xf9 $0xfa $0xfb $0xfc $0xfd $UD   $UD   (; F ;) ;)
  )
  ...
  (; 
   ...
   ;)
  (; Helper functions ;)
  ;; Sets flag registers accordingly to the resulting value from math operations.
  (func $set_flags (param $value i32)
    ;; If result equals 0 then ZF is set to 1; 0 otherwise.
    (select (i32.const 0) (i32.const 1)
            (local.get $value)
    )
    global.set $ZF
    ;; If the high-order bit of the result is a 1 then SF is set to 1; 0 otherwise. (Two's complement notation)
    (i32.store offset=12
      (i32.const 0)
    ...
    ;; If the result has even parity (an even number of 1-bits) PF is set to 1, 0 otherwise.
    block
      i32.const 0
      block
        block
  ...
  (func $ADD (param $destination i32) (param $source i32) (param $carry i32) (result i32)
  ...
  (func $0xd6 (; SALC ;)
    (select (i32.const 0xFF) (i32.const 0x00)
            (global.get $CF) ;; set AL to 256 if the carry flag is set, 0 otherwise.
    )
    global.set $AL
  )
